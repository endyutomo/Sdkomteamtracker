        ...
        <div className="space-y-6">
            ...
            {runnersUp.length > 0 && (
                <div className="bg-white rounded-xl border p-4 shadow-sm">
                    <h4 className="text-sm font-semibold text-muted-foreground mb-3 text-center uppercase tracking-wider">Runner Ups</h4>
                    <div className="space-y-2">
                        {runnersUp.map((sales, index) => (
                            <div key={sales.userId} className="flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                                <div className="flex items-center gap-4">
                                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-slate-100 font-bold text-slate-500 text-sm">
                                        {index + 4}
                                    </div>
                                    <div>
                                        <p className="font-semibold text-sm text-slate-700">{sales.userName}</p>
                                        <p className="text-xs text-muted-foreground capitalize">{sales.division}</p>
                                    </div>
                                </div>
